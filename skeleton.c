...
static char const * const body[] =
{
    ...
    "              yystate, yydepth, (yytrial ? \",trial\" : \"\"),",
    "              yytrial->state, yylvp - yylvals - yytrial->lexeme);",
    "    }",
    "#endif",
...
unsigned int section_list_btyaccpa_count = 48;
